...
```bash
INIT=$(node "C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/templates/spec.md.
