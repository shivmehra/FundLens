...
```markdown
Read C:/Shiv/Projects/AIML/FundLens/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Shiv/Projects/AIML/FundLens/.claude/agents/gsd-ui-checker.md for instructions.
