...
```
Task(
  prompt="Read C:/Shiv/Projects/AIML/FundLens/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/templates/VALIDATION.md`
