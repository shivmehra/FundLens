...
INSTALL_JS_GLOBAL="C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
