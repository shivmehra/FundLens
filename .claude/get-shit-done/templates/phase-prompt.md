...
<!-- For checkpoint task examples and patterns, see @C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
