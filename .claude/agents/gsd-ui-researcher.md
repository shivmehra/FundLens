...
Use template from `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/templates/UI-SPEC.md`
