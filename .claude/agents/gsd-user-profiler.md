...
<reference>
@C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Shiv/Projects/AIML/FundLens/.claude/get-shit-done/references/user-profiling.md` to load:
